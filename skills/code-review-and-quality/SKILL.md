...
description: Conducts a broad quality-oriented code review across correctness, readability, architecture, security, and performance. Use when you want a full-spectrum review of code quality, not a diff-to-spec comparison workflow.
---
