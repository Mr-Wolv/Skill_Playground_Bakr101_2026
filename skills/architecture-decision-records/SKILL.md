...
description: Write and maintain formal Architecture Decision Records (ADRs) for significant technical decisions. Use when the output should be an ADR specifically, rather than broader engineering documentation.
---
