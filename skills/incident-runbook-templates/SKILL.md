...
description: Create structured incident response runbooks with step-by-step procedures, escalation paths, and recovery actions. Use when authoring or standardizing runbooks for future responders rather than running an active incident workflow.
---
...
- Writing or improving the runbooks responders will use during incidents
