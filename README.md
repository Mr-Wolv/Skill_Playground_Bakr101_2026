...
> **A curated skill repository — 241 skills, mirrored with the global skill store.**
...
Skill Playground is a **skills repository** for the agent skills ecosystem. It currently contains **241 skills**, organized by both [SDLC phase](SKILL-CATALOG.md) and [engineering domain](SKILL-CATALOG-DOMAIN.md).
...
```
├── skills/                       # 241 skills (each has SKILL.md)
